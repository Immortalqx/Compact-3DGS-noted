...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from,
    ...
    # 这里直接传入dataset，因为Compact 3DGS不需要球谐函数，但是需要Geometry Codebook、Compact View-dependent Color相关的参数。
...
if __name__ == "__main__":
    ...
    parser.add_argument("--comp", action="store_true")  # 与3dgs相比，多了的参数
    parser.add_argument("--store_npz", action="store_true")  # 与3dgs相比，多了的参数
    ...
    training(lp.extract(args), op.extract(args), pp.extract(args), args.test_iterations, args.save_iterations,
             args.checkpoint_iterations, args.start_checkpoint, args.debug_from, args.comp, args.store_npz)
